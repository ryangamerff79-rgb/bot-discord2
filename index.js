...
tipo: "link",
link: "https://www.mediafire.com/file/gas56d3988tfhfl/otimizacao.rar/file",
qr: "https://cdn.discordapp.com/attachments/1373392385014370334/1494136411010498741/melifile.png"
},
opt10: {
preco: 10,
nome: "Otimização Avançada",
tipo: "link",
link: "https://www.mediafire.com/file/98zllqrqqtwe37c/file.rar/file",
qr: "https://cdn.discordapp.com/attachments/1373392385014370334/1494136583471890432/melifile.png"
},
opt20: {
preco: 20,
nome: "Otimização Suprema",
tipo: "link",
link: "https://www.mediafire.com/file/ui6oxugqqo5fv35/file.rar/file",
qr: "https://cdn.discordapp.com/attachments/1373392385014370334/1494136699129696266/melifile.png"
},
gta: {
preco: 5,
nome: "Conta GTA V",
...
nome: "Pack Sensi",
tipo: "link",
link: "https://www.mediafire.com/file/pack.rar/file"
}
};
...
if (produto.qr) embed.setImage(produto.qr);
...
return interaction.reply({ content: `💰 Lucro total: R$${total}`, ephemeral: true });
}

if (interaction.commandName === "lucromes") {
const mes = new Date().getMonth();
let total = Object.values(db.mensal[mes] || {}).reduce((a, b) => a + b, 0);
return interaction.reply({ content: `📅 Lucro do mês: R$${total}`, ephemeral: true });
}

if (interaction.commandName === "vendas") {
let total = Object.values(db.vendas).reduce((a, b) => a + b, 0);
return interaction.reply({ content: `📦 Total de vendas: ${total}`, ephemeral: true });
}
...
if (!entrega) {
return interaction.reply({ content: "❌ Nenhuma entrega encontrada", ephemeral: true });
}

await user.send(`📦 Reenvio:\n${entrega}`).catch(() => {});
return interaction.reply({ content: "✅ Reenviado!", ephemeral: true });
}
}
